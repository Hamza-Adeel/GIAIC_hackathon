...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-black relative">
      <div className="absolute right-0 bottom-0 w-[20vw] md:w-[14vw]">
        <Image src={Leaf} alt="" />
      </div>
      <div className="flex flex-col md:flex-row justify-between items-center bg-black px-[155px] py-[50px] relative">
      ...
      <div>
        <div className="mx-auto w-full max-w-screen-xl ">
          <div className="grid grid-cols-2  md:gap-[3vw] px-0 md:px-[130px] py-6 lg:py-8 md:grid-cols-4">
            <div>
              ...
              <ul className="text-gray-500  font-medium">
                <li className="mb-4">
                  <p className="text-[#FFFFFF] text-[11px] font-normal">
                ...
                <li className="flex gap-[16.5px]">
                  <div className="bg-[#FF9F0D] flex justify-center items-center w-[72px] h-[72px]">
                    <PiClockClockwise className="text-white text-[40px]" />
                  </div>
        ...
        <div className="h-[16vh]  px-14 py-6 w-full bg-[#FF9F0D] md:h-[10vh] md:flex md:items-center md:justify-between">
          <span className="text-center text-sm text-[#FFFFFF] sm:text-center md:ml-[8vw]">
            Copyright &copy; 2024 by Hamza Adeel. All Rights Reserved.
          </span>
          {/* <Image src={Leaf} alt=""/> */}
          <div className="flex justify-center gap-[2vw] mr-[11vw]">
