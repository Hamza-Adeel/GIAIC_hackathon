...
import starterImage from "@/app/assets/starter.png";
import desserts from "@/app/assets/desserts.png";
import drinks from "@/app/assets/drinks.png";
...
import professionalChef from "@/app/assets/professional-chefs.png"
import Customer from "@/app/assets/customer.png"
import ItemsOfFood from "@/app/assets/items-of-food.png"
...
const statsData = [
  {
    icon: <Image src={professionalChef} alt={"chef"} className="text-orange-500 text-5xl mx-auto mb-4"  />,
    number: "420",
    label: "Professional Chefs",
  },
  {
    icon: <Image src={ItemsOfFood} alt={"chef"} className="text-orange-500 text-5xl mx-auto mb-4" />,
    number: "320",
    label: "Items Of Food",
  },
  {
    icon: <Image src={Experience} alt={"chef"} className="text-orange-500 text-5xl mx-auto mb-4" />,
    number: "30+",
    label: "Years Of Experience",
  },
  {
    icon: <Image src={Customer} alt={"chef"} className="text-orange-500 text-5xl mx-auto mb-4" />,
    number: "220",
  ...
  return (
    <div>
      ...
      <section className="bg-white text-black  sm:px-16">
        ...
        {/* Stats Section */}
        <div className="relative text-white mb-16 w-full h-[50vh]">
          ...
          <div className="absolute inset-0 bg-black bg-opacity-80 z-10">
            <div className="container mx-auto flex justify-center items-center h-full">
              <div className="grid  md:grid-cols-4 gap-[10vw] text-center">
        ...
        {/* Client Logos */}
        <div className="flex justify-center items-center space-x-8 mb-8 gap-[2vw] ">
